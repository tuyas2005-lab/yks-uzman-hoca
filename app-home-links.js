(()=>{
  ...
  const official=makeGroup('official',['tests','questionIndex','teacher','crop-studio'],[
    ...
    ()=>loadScript('/app-crop-studio.js?v=6')
  ],()=>{
  ...
  groups.teacher=makeGroup('teacher',['teacher'],[
    ...
    ()=>loadScript('/app-personal-teacher-v2.js?v=11'),
    ...
    ()=>loadScript('/app-personal-teacher-policy-v3.js?v=23'),
