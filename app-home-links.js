...
(function bootV5Deps(tries=0){
  ...
  loadScript('/app-field-track.js?v=2',()=>{
    ...
    loadScript('/app-teacher-performance.js?v=2',()=>loadScript('/app-personal-teacher-v2.js?v=1',()=>loadScript('/app-source-set-tracking.js?v=1',()=>loadScript('/app-teacher-wrong-scope.js?v=1',()=>loadScript('/app-home-teacher-flow.js?v=1')))));
