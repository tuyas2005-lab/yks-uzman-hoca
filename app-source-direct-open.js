(()=>{
  ...
  function bind(){
    ...
    warmTimer=setTimeout(()=>{if(items.length&&!navigator.connection?.saveData)window.prepareSourceQuestions?.(items)},80);
  }
