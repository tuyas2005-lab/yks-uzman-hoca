(()=>{
  ...
  // tanimli DEGIL (bu dosyaya bu gorev kapsaminda dokunulmadi - madde 12 yasagi).
  // Bu yuzden crop koordinatlari DOGRU ve GORSEL OLARAK DOGRULANMIS olsa da,
  // runtime'da PDF.js getDoc() cagrisi bu pdfKey icin 404 alacak ve crop
  // GERCEKTEN GORUNTULENEMEYECEKTIR, SOURCES objesine 'osym-2023-tyt' eklenene
  // kadar. Bu eksiklik ayri bir onay/adim gerektirir, bkz. calisma raporu.
  function activate(){
